...
**Ссылка на макет:**  
https://www.figma.com/design/mdwsSS1sHJ6EHS56oWn8RB/Untitled?node-id=0-1&t=MoAOf1AfWqtkZQIS-1

> Примечание: для просмотра макета потребуется доступ к Figma. Если макет открыт для просмотра, любой участник сможет перейти по ссылке и изучить интерфейс.:contentReference[oaicite:1]{index=1}
